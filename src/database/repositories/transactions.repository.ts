import { GetDashBoardDTO, GetFinancialEvolutionDTO, IndexTransactionDTO } from "../../dtos/transactions.dto"
import { Balance } from "../../entities/balance.entity"
import { Expense } from "../../entities/expenses.entity"
import { Transaction, TransactionTypes } from "../../entities/transactions.entity"
...
export class TransactionRepository {
    ...
    async index({ title, categoryId, beginDate, endDate }: IndexTransactionDTO): Promise<Transaction[]> {
    ...
    async getFinancialEvolution({ year }: GetFinancialEvolutionDTO): Promise<Balance[]> {
      ...
      const result = await aggregate.match({
        date: {
